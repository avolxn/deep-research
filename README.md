...
**Deep Research** — мультиагентная система для проведения глубоких исследований. Использует Yandex GPT и Tavily Search для анализа и структурирования информации.
